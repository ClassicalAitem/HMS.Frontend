  ...
  const handleConfirm = async () => {
    try {
      ...
      toast.promise(promise, {
        ...
        error: (err) => err?.response?.data?.message || 'Failed to send to front desk',
      });
      await promise;
      onClose();
      ...
      <div className="relative z-10 w-full max-w-lg shadow-xl card bg-base-100">
        <div className="p-6 card-body">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-xl font-bold text-base-content">Send to Front Desk</h2>
...
export default FrontDeskActionModal;