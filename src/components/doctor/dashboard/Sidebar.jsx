...
import { MdOutlineDashboard, MdPeople, MdSchedule, MdLocalHospital, MdAssignment } from "react-icons/md";
...
const Sidebar = ({ onCloseSidebar }) => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      active: location.pathname === '/doctor/diagnosis'
    },
    {
      icon: MdAssignment,
      label: 'Prescriptions',
      ...
      <div className="p-4 border-t border-base-300">
        <div className="flex items-center space-x-3">
          <div className="flex justify-center items-center w-10 h-10 bg-blue-100 rounded-full">
            <img
              src="https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?q=80&w=1000&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
              alt="Dr. Michael Chen"
              className="object-cover w-10 h-10 rounded-full"
            />
          </div>
          <div className="flex-1">
            <p className="text-sm font-medium text-base-content">Dr. Michael Chen</p>
            <p className="text-xs text-primary">General Medicine</p>
          </div>
        </div>
      </div>
