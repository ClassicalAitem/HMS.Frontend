...
const Sidebar = ({ onCloseSidebar }) => {
  ...
  const menuItems = [
    { icon: FaThLarge, label: "Dashboard", path: "/dashboard/medical-director",  active: location.pathname === '/dashboard/medical-director' },
    { icon: FaInbox, label: "Incoming", path: "/dashboard/medical-director/incoming",  active: location.pathname === '/dashboard/medical-director/incoming' ,badge: location.pathname.startsWith("/dashboard/medical-director/incoming") ? 0 : incomingCount },
    // { icon: FaUserCheck, label: "Admitted Patients", path: "/dashboard/medical-director/admitted", badge: admittedCount },
    { icon: FaUserCheck, label: "Attended Today", path: "/dashboard/medical-director/attended-today", active: location.pathname === '/dashboard/medical-director/attended-today'   },
    { icon: SlCalender, label: "Appointments", path: "/dashboard/medical-director/appointments",  active: location.pathname === '/dashboard/medical-director/appointments' },
    { icon: FaUsers, label: "Patients", path: "/dashboard/medical-director/patients",  active: location.pathname === '/dashboard/medical-director/patientshistory' },
    // { icon: FaUsers, label: "All Patients", path: "/dashboard/medical-director/allPatients" },
    { icon: IoReceiptOutline, label: "Payment Records", path: "/dashboard/medical-director/payment-records", active: location.pathname === '/dashboard/medical-director/payment-records' },
  ];
  ...
  return (
   // Sidebar.jsx
<div className="flex flex-col w-full h-full border-r-2 bg-base-100 border-neutral/20 overflow-y-auto">
  {/* Logo */}
