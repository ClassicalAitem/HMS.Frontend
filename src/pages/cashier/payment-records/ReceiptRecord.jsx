...
const handlePrintReceipt = (payment) => {
  ...
  return (
    <CashierLayout>
      <div className="mb-4">
        <h1 className="text-2xl font-bold text-base-content">Payment Receipt Records</h1>
        <p className="text-sm text-base-content/70">View and manage all payment receipt transactions</p>
      </div>
