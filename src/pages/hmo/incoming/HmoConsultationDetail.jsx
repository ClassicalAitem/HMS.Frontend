        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-6">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-xl font-bold text-primary">Consultation Detail</h1>
            </div>
          </div>
            ...
            <div className="space-y-4 max-w-4xl">
              ...
              <div className={`rounded-xl p-4 flex items-center justify-between ${
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-bold text-base-content">{subjectName}</p>
                    {isDependant && (
                ...
                <span className={`badge ${isDependant ? 'badge-secondary' : 'badge-primary'}`}>
                ...
                <Section title="Complaints">
                  <div className="space-y-2">
                    {consultation.complaint.map((c, i) => (
                      <div key={i} className="flex items-center justify-between p-3 rounded-lg bg-base-200/50">
                        <span className="text-sm font-medium">{c.symptom || '—'}</span>
                        <span className="text-xs text-base-content/50">{c.durationInDays ? `${c.durationInDays} day(s)` : ''}</span>
                      </div>
                    ))}
                  </div>
                </Section>
                ...
                <Section title="Family History">
                  <div className="space-y-2">
                    {consultation.familyHistory.map((f, i) => (
                      <div key={i} className="flex items-center gap-3 p-3 rounded-lg bg-base-200/50">
                        ...
                        {f.value && <span className="text-xs text-base-content/50 ml-auto">{f.value}</span>}
                      </div>
                    ))}
                  </div>
                </Section>
