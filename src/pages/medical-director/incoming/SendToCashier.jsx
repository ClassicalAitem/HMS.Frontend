      ...
      <div className="flex overflow-hidden flex-col flex-1 bg-base-300/20">
        ...
        <div className="flex overflow-y-auto flex-col p-2 py-1 h-full sm:p-6 sm:py-4">
          <PatientHeaderActions
            ...
            onBack={() => navigate(`/dashboard/medical-director/medical-history/${patientId}`, { state: { from: fromIncoming ? "incoming" : "patients", patientSnapshot: patient } })}
          />
          ...
          <div className="flex gap-4 items-center mb-4 justify-between">
            <div className="flex gap-4 items-center">
              ...
              <button className="btn btn-outline btn-sm" onClick={() => navigate(`/dashboard/medical-director/send-to-pharmacy/${patientId}`, { state: { from: fromIncoming ? "incoming" : "patients", patientSnapshot: patient } })}>Send to Pharmacy</button>
              <button className="btn btn-outline btn-sm" onClick={() => navigate(`/dashboard/medical-director/send-to-nurse/${patientId}`, { state: { from: fromIncoming ? "incoming" : "patients", patientSnapshot: patient } })}>Send to Nurse</button>
            </div>

            <div className="hidden">
              <button className="btn btn-outline btn-sm" onClick={() => navigate(`/dashboard/medical-director/medical-history/${patientId}`)}>Back</button>
            </div>
          </div>
              ...
              <div className="shadow-xl card bg-base-100">
                <div className="p-4 card-body">
                  ...
                  <div className="space-y-2 text-sm text-base-content/70">
                    ...
                    <div className="flex justify-between"><span>Medical Director</span><span>Dr. {user ? `${user.firstName} ${user.lastName}` : "—"}</span></div>
                  </div>
                </div>
              </div>
              <div className="shadow-xl card bg-base-100">
