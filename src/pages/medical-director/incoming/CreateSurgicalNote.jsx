  ...
  const handleSubmit = async (e) => {
   ...
   // Prepare payload to match ISurgery
    ...
    try {
      ...
      navigate(`/dashboard/medical-director/medical-history/${patientId}/consultation/${consultationId}`, { state: { from: fromIncoming ? "incoming" : "patients", patientSnapshot: patient } });
    } catch (err) {
