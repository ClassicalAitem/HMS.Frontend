        ...
        <div className="flex overflow-y-auto flex-col p-2 py-1 h-full sm:p-6 sm:py-4">
          ...
          <div className="flex gap-4 items-center mb-4 justify-between">
            <div className="flex gap-4 items-center">
              ...
              <button className="btn btn-outline btn-sm" onClick={() => navigate(`/dashboard/medical-director/send-to-cashier/${patientId}`, { state: { from: fromIncoming ? "incoming" : "patients", patientSnapshot: patient } })}>Send to Cashier</button>
