...
const payload = {
  ...
  status: editingPrescription?.status || "pending"
    ...
    if (isAntenatal) {
      navigate(`/dashboard/medical-director/antenatal-records/${patientId}/view`, {
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 mx-auto">
                ...
                <div className="flex justify-end gap-4 pt-4 pb-8">
                  <button
                    ...
                    onClick={() => {
                      if (isAntenatal) {
                        navigate(`/dashboard/medical-director/medical-history/${patientId}/antenatal-details/${patientId}`, {
                          state: { from: "antenatal" }
                        });
                      } else {
                        navigate(`/dashboard/medical-director/medical-history/${patientId}/consultation/${consultationId}`, {
