  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        console.error("MDDashboard: metrics fetch error", e);
        ...
        <div className="overflow-y-auto flex-1">
          <section className="p-7">
            <div className="w-[687px]">
              <h1 className="text-4xl font-regular">Welcome, Medical Director <span className="font-bold text-primary">{`${[user?.firstName, user?.lastName].filter(Boolean).join(' ') || 'User'}`}</span></h1>
